...
var xunfeiListenSpeaking = {
	...
	startSpeak:function(success,error,speakMessage,parameter){
		exec(success,error,"XunfeiListenSpeaking","startSpeak",[speakMessage,parameter]);
	},
	stopSpeak:function(){
    ...
    resumeSpeaking: function(success,error,speakMessage) {
        exec(success, error, 'XunfeiListenSpeaking', 'resumeSpeaking', []);
    }
